...
public class MyRevealLayout extends android.widget.RelativeLayout implements Runnable{
	...
	private int INVALIDATE_DURATION = 10;//40>20
	...
	public void init(){
		...
		mPaint.setColor(getResources().getColor(getResources().getIdentifier("reveal_color", "color", getContext().getPackageName())));
	}
	...
	public boolean dispatchTouchEvent(MotionEvent event) {
		...
		switch(action){
			...
			case MotionEvent.ACTION_UP:
				...
				postDelayed(mDispatchUpTouchEventRunnable, INVALIDATE_DURATION);//40>20
				break;
